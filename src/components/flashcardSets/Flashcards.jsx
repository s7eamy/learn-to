...
const Flashcards = () => {
	...
	useEffect(() => {
		...
		const handleMouseMove = (e) => {
			if (scrollInfo.isDragging) {
				...
				flashcardsListRef.current.scrollTop = scrollInfo.scrollStartPosition + scrollAmount;
				updateScrollThumbPosition();
			}
		};
	...
	}, [scrollInfo.isDragging, scrollInfo.startY, scrollInfo.scrollStartPosition]);
	...
	const handleDelete = (cardId) => {
		fetch(`/api/sets/${setId}/cards/${cardId}`, {
			method: "DELETE",
		})
			.then((res) => {
				if (!res.ok) {
				...
				<Box sx={{ width: "100%", maxWidth: "1920px" }}>
					...
					>
						...
						>
							...
							<IconButton sx={{ color: "white" }} onClick={() => navigate("/sets")}>
								<CloseIcon />
							</IconButton>
						</Box>
						...
						>
							...
							>
								...
								>
									...
									>
										<MoreVertIcon sx={{ color: "#d9d9d9", fontSize: "30px" }} />
									</IconButton>
