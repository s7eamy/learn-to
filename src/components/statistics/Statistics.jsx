  ...
  return (
    ...
    >
      <CardContent>
        ...
        <Typography variant="h3" sx={{ fontWeight: "bold", fontFamily: "Poppins-SemiBold, Helvetica" }}>
          {value}
        </Typography>
      </CardContent>
    </Card>
...
const Statistics = () => {
  ...
  if (error) {
    return (
      ...
      >
        <Typography variant="h5" sx={{ mb: 3 }}>Error: {error}</Typography>
      ...
      <Container maxWidth="lg" sx={{ mt: 10, mb: 5 }}>
        ...
        >
          ...
          <Box sx={{ display: "flex", justifyContent: "center", mt: 4 }}>
            ...
            >
              <Typography sx={{ fontFamily: "Poppins-Medium, Helvetica", fontWeight: 500 }}>
                Back to Dashboard
              </Typography>
            </Button>
          </Box>
